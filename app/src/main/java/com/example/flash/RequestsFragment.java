...
public class RequestsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRequestsList = (RecyclerView) RequestsFragmentView.findViewById(R.id.chatRequestList);
                        ...
                        getTypeRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                    ...
                                    {
                                         Button request_sent_btn = holder.itemView.findViewById(R.id.requestAccept);
                                        request_sent_btn.setText("Req Sent");

                                        holder.itemView.findViewById(R.id.requestCancel).setVisibility(View.INVISIBLE);
